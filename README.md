...
>
> После изменений в файле напишите exec start в консоль, что бы применить изменения.
...
>
>  After making changes to the file, write exec start in the console to apply the changes.
